...
class OrderCancelWidgetDependencyProvider extends AbstractBundleDependencyProvider
{
    ...
    protected function addCustomerClient(Container $container): Container
    {
        $container->set(static::CLIENT_CUSTOMER, function (Container $container) {
            return new OrderCancelWidgetToCustomerClientBridge($container->getLocator()->customer()->client());
        });
    ...
    protected function addSalesClient(Container $container): Container
    {
        $container->set(static::CLIENT_SALES, function (Container $container) {
            return new OrderCancelWidgetToSalesClientBridge($container->getLocator()->sales()->client());
        });
